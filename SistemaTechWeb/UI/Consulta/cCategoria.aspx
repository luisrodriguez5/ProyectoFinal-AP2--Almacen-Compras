<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="cCategoria.aspx.cs" Inherits="SistemaTechWeb.UI.Consulta.cCategoria" %>
    ...
    <div class="row container">
        <div class="col-12">
            <asp:GridView CssClass="table table-responsive table-hover" BorderStyle="None" AutoGenerateColumns="false" GridLines="Horizontal"
                ID="CategoriaConsulta" DataKeyNames="CategoriaId, Nombre" ShowFooter="true" runat="server">
                <HeaderStyle CssClass="bg-danger" />
                <Columns>
                    <asp:BoundField DataField="CategoriaId" HeaderText="Categoria Id" />
                    <asp:BoundField DataField="Nombre" HeaderText="Nombres" />
                    <asp:BoundField DataField="Codigo" HeaderText="Codigo" />
                    <asp:BoundField DataField="Descripcion" HeaderText="Discripcion" />
