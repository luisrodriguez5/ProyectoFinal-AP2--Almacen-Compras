<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="cProductos.aspx.cs" Inherits="SistemaTechWeb.UI.Consulta.cProductos" %>
    ...
    <div class="row container">
        <div class="col-12">
            <asp:GridView CssClass="table table-responsive table-hover" BorderStyle="None" AutoGenerateColumns="false" GridLines="Horizontal"
                ID="ProductosConsulta" DataKeyNames="ProductoId, Nombre" ShowFooter="true" runat="server">
